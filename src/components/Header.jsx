...
function changeMenu(){
  ...
  return (
    <nav className='flex px-[20px] py-[15px] md:px-[40px] md:py-[30px] justify-between items-center'>
        <div className='flex justify-center items-center gap-[30px]'>
            <a href='/' className='flex justify-center items-center gap-[8px]'>
            ...
            <ul className='hidden md:flex text-[20px] justify-center items-center gap-[20px]'>
                <li className='hover:text-[#FF5555] font-semibold'>
                    <a href="/">Home</a>
                </li>
                <li className='hover:text-[#FF5555] font-semibold'>
        ...
        <div className='flex justify-center items-center gap-[20px] relative'>
            <div className='text-[15px]'>
                <a className='bg-black text-white px-[20px] py-[12px] md:px-[40px] md:py-[15px]  rounded-[8px]' href="">Download</a>
            </div>
